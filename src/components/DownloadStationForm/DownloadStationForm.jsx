...
const DownloadStationForm = () => {
  ...
  const handleDownload = async (e) => {
    ...
    const apiUrl = `${BASE_URL}/line_csv/${lineId}/export/stations`;
    ...
    try {
      ...
      if (response.ok) {
        ...
        const filename = `stations_line_${lineId}.csv`; // Use Line ID in the filename
        ...
        setResponseMessage("역 정보가 성공적으로 다운로드되었습니다.");
      } else {
      ...
      <div className="container max-w-screen-lg mx-auto">
        <div>
          ...
          <p className="text-gray-500 mb-6">
            호선 ID를 입력하여 해당 호선의 역 정보를 CSV 파일로 다운로드합니다.
          </p>

          <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
              <div className="text-gray-600">
                <p className="font-medium text-lg">역 정보 다운로드</p>
...
export default DownloadStationForm;
