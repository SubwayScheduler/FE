...
const DriveDeleteForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const apiUrl = `${BASE_URL}/train_motorman/${trainId}/${motormanId}`;
    ...
    try {
      ...
      if (response.ok) {
        ...
        setResponseMessage(
          data.message || "운전 정보가 성공적으로 삭제되었습니다."
        );
      } else {
      ...
      <div className="container max-w-screen-lg mx-auto">
        <div>
          ...
          <p className="text-gray-500 mb-6">
            객차 ID와 기관사 ID를 입력하여 운전 정보를 삭제합니다.
          </p>

          <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
              <div className="text-gray-600">
                <p className="font-medium text-lg">운전 정보 삭제</p>
                <p>객차 ID와 기관사 ID를 입력하여 운전 정보를 삭제하십시오.</p>
              </div>
...
export default DriveDeleteForm;
