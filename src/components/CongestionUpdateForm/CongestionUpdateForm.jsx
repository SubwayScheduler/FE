...
const CongestionUpdateForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const deleteUrl = `${BASE_URL}/line_csv/${lineId}/delete/congestion`;
    const uploadUrl = `${BASE_URL}/line_csv/${lineId}/import/congestion`;

    try {
      // Step 1: Delete existing congestion data
      ...
      setResponseMessage(
        deleteMessage.message || "기존 혼잡도 데이터 삭제 성공."
      );

      // Step 2: Upload new congestion data
      ...
      setResponseMessage(
        uploadMessage.message || "혼잡도 정보가 성공적으로 업데이트되었습니다."
      );
    } catch (error) {
      ...
      <div className="container max-w-screen-lg mx-auto">
        <div>
          ...
          <p className="text-gray-500 mb-6">
            호선 ID와 CSV 파일을 입력하여 혼잡도 정보를 업데이트합니다.
          </p>

          <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
              <div className="text-gray-600">
                <p className="font-medium text-lg">혼잡도 정보 입력</p>
                <p>
                  호선 ID와 CSV 파일을 입력하여 혼잡도 정보를 업데이트하십시오.
                </p>
              </div>
...
export default CongestionUpdateForm;
